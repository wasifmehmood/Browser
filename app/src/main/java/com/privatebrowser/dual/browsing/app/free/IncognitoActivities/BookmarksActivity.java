...
import com.privatebrowser.dual.browsing.app.free.Adapters.BookmarksAdapter;
...
import static com.privatebrowser.dual.browsing.app.free.Adapters.BookmarksAdapter.bookmarksList;
import static com.privatebrowser.dual.browsing.app.free.Adapters.BookmarksAdapter.bookmarksUrlList;
...
//        Toast.makeText(this, "Str"+activityStr, Toast.LENGTH_SHORT).show();
        ...
        try {
            Class<?> aclass = Class.forName("com.privatebrowser.dual.browsing.app.free.DualBrowserActivities.DualBrowserActivity");
