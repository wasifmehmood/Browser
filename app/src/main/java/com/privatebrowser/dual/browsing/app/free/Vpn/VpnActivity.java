...
//import com.privatebrowser.dual.browsing.app.free.dialog.LoginDialog;
import com.privatebrowser.dual.browsing.app.free.VpnDialog.RegionChooserDialog;
...
public class VpnActivity extends UIActivity implements TrafficListener, VpnStateListener,
    ...
    public void onTrafficUpdate(long bytesTx, long bytesRx) {
        updateUI();
        updateTrafficStates(bytesTx, bytesRx);
    }
